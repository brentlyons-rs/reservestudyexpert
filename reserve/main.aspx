...
<script src="assets/js/jquery-ui-1.8.22.js"></script>
<script src="assets/js/jquery.mask.min.js"></script>
<link href="assets/css/jquery-ui-1.8.10.css" rel="stylesheet" />
...
<link href="css/style.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#MainContent_txtNewProjectID').mask('00000-00');
            <% } %>
        });  
        ...
        function CheckNewProject() {
            if (document.getElementById('txtNewProjectID').value.length != 8) {
                alert("Please enter a project number in 00000-00 format.");
                document.getElementById('txtNewProjectID').focus();
                return false;
            }
            if (document.getElementById('txtNewProjectName').value=='') {
                alert("Please enter a project name.");
                document.getElementById('txtNewProjectName').focus();
                return false;
            }
            if (document.getElementById('txtNewReportEffective').value.length==0) {
                alert("Please enter a report effective date.");
        ...
        function initItemsChanged() {
            if (isProjectSelected) {
                sElems[0] = document.getElementById('MainContent_cboPT').value; //0
                sElems[1] = document.getElementById('MainContent_txtPN').value; //1
                sElems[2] = document.getElementById('MainContent_txtPM').value; //2
                sElems[3] = document.getElementById('MainContent_txtAoC').value; //3
                sElems[4] = document.getElementById('MainContent_txtNU').value; //4
                sElems[5] = document.getElementById('MainContent_txtNB').value; //5
                sElems[6] = document.getElementById('MainContent_txtNF').value; //6
                sElems[7] = document.getElementById('MainContent_txtSA1').value; //7
                sElems[8] = document.getElementById('MainContent_txtSA2').value; //8
                sElems[9] = document.getElementById('MainContent_txtSC').value; //9
                sElems[10] = document.getElementById('MainContent_cboSS').value; //10
                sElems[11] = document.getElementById('MainContent_txtSZ').value; //11
                sElems[12] = document.getElementById('MainContent_txtID').value; //12
                sElems[13] = document.getElementById('MainContent_txtRE').value; //13
                sElems[14] = document.getElementById('MainContent_txtGF').value; //14
                sElems[15] = document.getElementById('MainContent_txtInt').value; //15
                sElems[16] = document.getElementById('MainContent_txtInf').value; //16
                sElems[17] = document.getElementById('MainContent_cboCP').value; //17
                sElems[18] = document.getElementById('MainContent_txtCN').value; //18
                sElems[19] = document.getElementById('MainContent_txtCT').value; //19
                sElems[20] = document.getElementById('MainContent_txtCoN').value; //20
                sElems[21] = document.getElementById('MainContent_txtCP').value; //21
                sElems[22] = document.getElementById('MainContent_txtCE').value; //22
                sElems[23] = document.getElementById('MainContent_txtClA1').value; //23
                sElems[24] = document.getElementById('MainContent_txtClA2').value; //24
                sElems[25] = document.getElementById('MainContent_txtClC').value; //25
                sElems[26] = document.getElementById('MainContent_cboCS').value; //26
                sElems[27] = document.getElementById('MainContent_txtClZ').value; //27
                sElems[28] = document.getElementById('MainContent_txtBB').value; //28
                sElems[29] = document.getElementById('MainContent_txtCC').value; //29
                sElems[30] = document.getElementById('MainContent_cboSP').value; //30
                sElems[31] = document.getElementById('MainContent_txtSN').value; //31
                sElems[32] = document.getElementById('MainContent_txtST').value; //32
                sElems[33] = document.getElementById('MainContent_txtPP').value; //33
                sElems[34] = document.getElementById('MainContent_txtPRC').value; //34
                sElems[35] = document.getElementById('MainContent_txtSBB').value; //35
                sElems[36] = document.getElementById('MainContent_txtPSD').value; //36
            ...
            //    sElems.push(document.getElementById('MainContent_txtInt').value); //15
            //    sElems.push(document.getElementById('MainContent_txtInf').value); //16
            //    sElems.push(document.getElementById('MainContent_cboCP').value); //17
            //    sElems.push(document.getElementById('MainContent_txtCN').value); //18
            //    sElems.push(document.getElementById('MainContent_txtCT').value); //19
            //    sElems.push(document.getElementById('MainContent_txtCoN').value); //20
            //    sElems.push(document.getElementById('MainContent_txtCP').value); //21
            //    sElems.push(document.getElementById('MainContent_txtCE').value); //22
            //    sElems.push(document.getElementById('MainContent_txtClA1').value); //23
            //    sElems.push(document.getElementById('MainContent_txtClA2').value); //24
            //    sElems.push(document.getElementById('MainContent_txtClC').value); //25
            //    sElems.push(document.getElementById('MainContent_cboCS').value); //26
            //    sElems.push(document.getElementById('MainContent_txtClZ').value); //27
            //    sElems.push(document.getElementById('MainContent_txtBB').value); //28
            //    sElems.push(document.getElementById('MainContent_txtCC').value); //29
            //    sElems.push(document.getElementById('MainContent_cboSP').value); //30
            //    sElems.push(document.getElementById('MainContent_txtSN').value); //31
            //    sElems.push(document.getElementById('MainContent_txtST').value); //32
            //    sElems.push(document.getElementById('MainContent_txtPP').value); //33
            //    sElems.push(document.getElementById('MainContent_txtPRC').value); //34
            //    sElems.push(document.getElementById('MainContent_txtSBB').value); //35
            //    sElems.push(document.getElementById('MainContent_txtPSD').value); //36
            }
        }

        function isItemChanged(elemId, newVal) {
            if (sElems[elemId] != newVal) {
                return true;
            }
            else {
                return false;
        ...
        function checkDelProject() {
            if (confirm("Deleting this project will permanently delete ALL revisions, photos, projections, and project-related data. Are you SURE you want to continue?")==1) {
                document.getElementById('MainContent_txtHdnType').value = 'DeleteProject';
                document.forms[0].submit();
            }
        }

        function toggleFormEnabled(isDisabled) {
            document.querySelectorAll('#formID input, #formID select, #formID button, #formID textarea').forEach(elem => elem.disabled = isDisabled);
        }
    </script>
<form id="frmProject" runat="server">
    <div class="container_fluid" id="container_main" style="max-width: 100%">
        ...
        <% if (txtHdnProject.Value != "-1")
            { %>
        <script>isProjectSelected = true;</script>
        <table class="table table-striped table-condensed" style="width:100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="form-inline"><select class="form-control" id="cboPT" runat="server" onchange="saveProjectInfo(0,'pty','project type',this.value)"></select></td>

                    <td class="form-inline text-right"><label class="frm-text-bold">Project number:</label></td>
                    <td class="form-inline"><div class="col"><input type="text" runat="server" class="form-control" id="txtPID" maxlength="15" placeholder="00000-00"></div></td>

                    <td class="form-inline text-right"><label class="frm-text-bold">Project name:</label></td>
                    <td class="form-inline"><div class="col"><input type="text" runat="server" class="form-control" id="txtPN" maxlength="100" onblur="saveProjectInfo(1,'pna','project name',this.value)"></div></td>

                    <td class="form-inline text-right"><label class="frm-text-bold">Project manager:</label></td>
                    <td class="form-inline"><div class="col"><input type="text" runat="server" class="form-control" id="txtPM" maxlength="50" onblur="saveProjectInfo(2,'pmg','project manager',this.value)"></div></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtAoC" onkeypress="return isNumber(event)" onblur="saveProjectInfo(3,'aco','age of community',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text"># of units:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtNU" onkeypress="return isNumber(event)" onblur="saveProjectInfo(4,'nun','number of units',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text"># of bldgs:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtNB" onkeypress="return isNumber(event)" onblur="saveProjectInfo(5,'nbl','number of buildings',this.value)"></td>
            
                    <td class="form-inline text-right"><label class="frm-text"># of floors:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtNF" onkeypress="return isNumber(event)" onblur="saveProjectInfo(6,'nfl','number of floors',this.value)"></td>
                </tr>
                <tr>
                    <td class="form-inline text-right"><label class="frm-text">Site address 1:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtSA1" maxlength="50" onblur="saveProjectInfo(7,'sa1','site address 1',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Site address 2:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtSA2" maxlength="50" onblur="saveProjectInfo(8,'sa2','site address 2',this.value)"></td>
                </tr>
                <tr>
                    <td class="form-inline text-right"><label class="frm-text">Site city:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtSC" maxlength="50" onblur="saveProjectInfo(9,'sci','site city',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Site state:</label></td>
                    <td class="form-inline"><select class="form-control" id="cboSS" runat="server" onchange="saveProjectInfo(10,'sst','site state',this.value)"></select></td>

                    <td class="form-inline text-right"><label class="frm-text">Site zip:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtSZ" maxlength="15" onblur="saveProjectInfo(11,'szi','site zip',this.value)"></td>
                ...
                <tr>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtID" placeholder="mm/dd/yyyy" onblur="saveProjectInfo(12,'ida','inspection date',this.value)"></td>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtRE" placeholder="mm/dd/yyyy" onblur="saveProjectInfo(13,'ref','report effective',this.value)"></td>
                    ...
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtGF" onkeypress="return isNumber(event)" onblur="saveProjectInfo(14,'gfa','geo factor',this.value)"><input id="txtHdnGF" type="hidden" runat="server" /></td>
                </tr>
                <tr>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtInt" placeholder="0.00" onkeypress="return isNumber(event)" onblur="saveProjectInfo(15,'int','interest',this.value)"></td>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtInf" placeholder="0.00" onkeypress="return isNumber(event)" onblur="saveProjectInfo(16,'inf','inflation',this.value)"></td>
                ...
                <tr>
                    ...
                    <td class="form-inline"><select class="form-control" id="cboCP" runat="server" onchange="saveProjectInfo(17,'cpr','contact prefix',this.value)"><option>Mr.</option><option>Ms.</option><option>Mrs.</option></select></td>

                    <td class="form-inline text-right"><label class="frm-text">Contact name:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtCN" maxlength="50" onblur="saveProjectInfo(18,'cna','contact name',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Contact title:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtCT" maxlength="50" onblur="saveProjectInfo(19,'cti','contact title',this.value)"></td>

                    <td colspan="2"></td>
                </tr>
                <tr>
                    <td class="form-inline text-right text-nowrap"><label class="frm-text">Association name:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtCoN" maxlength="50" onblur="saveProjectInfo(20,'ana','association name',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Contact phone:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtCP" maxlength="25" onblur="saveProjectInfo(21,'cph','contact phone',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Contact email:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtCE" maxlength="50" onblur="saveProjectInfo(22,'cem','contact email',this.value)"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="7" class="frm-text text-left" style="padding: 0px; margin: 0px">
                        <input class="form-check-input" type="checkbox" value="" id="chkSS" onclick="saveProjectInfo(this.checked ? '1' : '0','sameassite','',this.checked)"><label class="frm-text" for="chkSS">Make Client Info the same as site info</label>
                    </td>
                </tr>
                <tr>
                    <td class="form-inline text-right"><label class="frm-text">Client address 1:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtClA1" maxlength="50" onblur="saveProjectInfo(23,'ca1','client address 1',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Client address 2:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtClA2" maxlength="50" onblur="saveProjectInfo(24,'ca2','client address 2',this.value)"></td>

                </tr>
                <tr>
                    <td class="form-inline text-right"><label class="frm-text">Client city:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtClC" maxlength="50" onblur="saveProjectInfo(25,'cci','client city',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Client state:</label></td>
                    <td class="form-inline"><select class="form-control" id="cboCS" runat="server" onchange="saveProjectInfo(26,'cst','client state',this.value)"></select></td>

                    <td class="form-inline text-right"><label class="frm-text">Client zip:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtClZ" maxlength="15" onblur="saveProjectInfo(27,'czi','client zip',this.value)"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtBB" placeholder="0.00" onkeypress="return isNumber(event)" onblur="saveProjectInfo(28,'bba','beginning balance',this.value)"></td>
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtCC" placeholder="0.00" onkeypress="return isNumber(event)" onblur="saveProjectInfo(29,'cco','current contribution',this.value)"></td>
                </tr>
                <tr>
                    <td class="frm-text text-left" style="padding: 0px; margin: 0px"></td>
                    <td colspan="7" class="frm-text text-left" style="padding: 0px; margin: 0px">
                        <input class="form-check-input" type="checkbox" value="" id="chkSC" onclick="saveProjectInfo(this.checked ? '1' : '0','sameascontact','',this.checked)"><label class="frm-text" for="chkSC">Make Source Info the same as contact info</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr id="trUpdate">
                    ...
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtPP" maxlength="50" onblur="saveProjectInfo(34,'ppr','previous preparer',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Previous recomm. cont:</label></td>
                    <td class="form-inline"><input type="text" class="form-control" runat="server" id="txtPRC" placeholder="0.00" onkeypress="return isNumber(event)" onblur="saveProjectInfo(35,'pre','previous recommended contribution',this.value)"></td>

                    <td class="form-inline text-right"><label class="frm-text">Prev study date:</label></td>
                    <td class="form-inline" colspan="3"><input type="text" class="form-control" runat="server" id="txtPSD" placeholder="mm/dd/yyyy" onblur="saveProjectInfo(36,'pst','previous study date',this.value)"></td>
                </tr>
            </tbody>
        </table>
        <% } %>
    ...
    <div class="modal fade" id="mdlNewProject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body mt-0 mb-0 p-0" style="margin-top: 0px">
                <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                    <table style="width: 100%">
                        <tr>
                            <td valign="top" width="1%" style="white-space: nowrap"><h5 class="text-right">Project Number:&nbsp;</h5></td>
                            <td><input type="text" id="txtNewProjectID" name="txtNewProjectID" class="form-control" placeholder="00000-00"></td>
                        </tr>
                        <tr>
                            <td valign="top" width="1%" style="white-space: nowrap"><h5 class="text-right">Project Name:&nbsp;</h5></td>
                            <td><input type="text" id="txtNewProjectName" name="txtNewProjectName" class="form-control" style="width: 100% !important"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td class="text-left">
                                <button type="button" id="btnSaveNewProject" class="btn btn-success" onclick="CheckNewProject()">Create Project</button>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="text-align: left">
                                <label id="lblNewProjectResult" name="lblNewProjectResult" class="frm-text-red" style="display: none">Status stuff goes here.</label>
                                <label id="lblNewProjectSave" name="lblNewProjectSave" class="frm-text-blue" style="display: none"><img src="images/ajax_load.gif" /> Creating new project, please wait...</label>
                            </td>
                        </tr>
                    </table>
                </div>
